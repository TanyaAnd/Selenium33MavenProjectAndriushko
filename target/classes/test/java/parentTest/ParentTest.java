...
public class ParentTest {
    ...
    public ServiceEditPage serviceEditPage;
...
//                {"remote"}
    ...
    @Before
    public void setUp() {
        pathToScreenShot = "/target/screenshot/" + this.getClass().getPackage().getName() + "/" + this.getClass().getSimpleName()
         + this.testName.getMethodName() + ".jpg";

        if ("chrome".equals(browser))
        {
            log.info("Chrome will be started");
            File fileFF = new File("./Drivers/chromedriver1");
        ...
        serviceEditPage = new ServiceEditPage(driver);
